...
public class PdpObjects extends Base {
	...
	WebElement hpElectronicsBanner;
	...
	@FindBy(xpath = "//span[@id='sku-30']")
	public WebElement levisSku;
	...
	@FindBy(xpath = "//div[@class='sku']/child::span[2]")
	...
	public void levisPdp(String quantity) {
		plp = new PlpObjects();
		plp.clothingPlp();
		levisLink.click();
		quantityField.clear();
	...
	public void adidasPdp(String size) {
		plp = new PlpObjects();
		plp.shoesPlp();
		adidasLink.click();
		Select sizeManu = new Select(adidasSizeDropBox);
		sizeManu.selectByVisibleText(size);
	}

	public void firstPrizePiesPdp() {
		plp = new PlpObjects();
		plp.booksPlp();
		firstPrizePiesLink.click();
	}
