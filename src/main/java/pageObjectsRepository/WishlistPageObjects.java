...
public class WishlistPageObjects extends Base {
	...
	ShoppingCartPageObjects shoppingCart = new ShoppingCartPageObjects();
	...
	//verification
	public void verifyItemAddToCartSuccessfulFromShoppingCartPOM() {
		//shoppingCart = new ShoppingCartPageObjects();
		//Assert.assertTrue(shoppingCart.shLevisItem.isDisplayed());
	}
	...
	public void verifyInciresePriceWithQuantity() {
		...
		String quantityTxt = userTestData.validQuantity5;
