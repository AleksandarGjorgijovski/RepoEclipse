...
public class PdpPomTestScripts extends Base {
	...
	public void TC_DETAILS_013_VerifyDonwloadSample() throws InterruptedException {
		plp.hpDigitalDownloadsBanner.click();
